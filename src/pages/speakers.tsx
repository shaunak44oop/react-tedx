...
import { Clock, Hexagon, ArrowRight, Coffee, Mic, Flag, DoorOpen } from "lucide-react";
...
export function Schedule() {
  return (
    <div className="min-h-screen bg-[#050507] text-white overflow-hidden font-['Inter',sans-serif] font-light relative selection:bg-[#EB0028] selection:text-white">
      ...
      {/* HERO SECTION — EXACT MATCH TO SPEAKERS HERO STYLE */}
      ...
      {/* CALL TO ACTION — DARK CRIMSON ACCENT COLOR */}
